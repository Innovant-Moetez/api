...
userSchema.methods.generateAuthToken = function() {
    const token = JWt.sign({ _id: this._id, isAdmin: this.isAdmin,fullName:this.fullName,email:this.email }, 'JwtPrivateKey'); // return token contien  id and name ,full name and email codé 
    return token;
}
